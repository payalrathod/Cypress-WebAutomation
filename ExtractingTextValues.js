...
describe('First test suite', () => {
  ...
  it.only('extract text values', () => {
    ...
    cy.get('[for="exampleInputEmail1"]').then( label => {
      ...
      expect(labeltext).to.equal('Email address')  //can be used only in Jquery type of syntax
    ...
    cy.get('[for="exampleInputEmail1"]').invoke('text').as('labelText').as('labelText').should('contain', 'Email address')
